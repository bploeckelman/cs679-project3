...
function Wave (round, game) {
    ...
    var self = this,
        ...
        ROUND_DETAILS = [
            { numEnemies: 1,   health: 10,  size: 10, speed: 0.25 },
            { numEnemies: 1,   health: 20,  size: 12, speed: 0.70 },
            { numEnemies: 1,  health: 40,  size: 14, speed: 1.25 },
            { numEnemies: 1,  health: 60,  size: 16, speed: 1.75 },
            { numEnemies: 1,  health: 80,  size: 18, speed: 2.25 },
            { numEnemies: 1,  health: 100, size: 20, speed: 2.75 },
        ];
